        ...
        <div className='fixed inset-0 overflow-hidden pointer-events-none z-0'>
          <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] opacity-10'>
            ...
            >
              ...
              {/* 外側の円 */}
              <circle cx='100' cy='100' r='95' fill='none' stroke='url(#goldGradient)' strokeWidth='1' />
              <circle cx='100' cy='100' r='85' fill='none' stroke='url(#goldGradient)' strokeWidth='0.5' />
              {/* 六芒星 */}
              <polygon
              ...
              />
              {/* 内側の円 */}
              <circle cx='100' cy='100' r='50' fill='none' stroke='url(#goldGradient)' strokeWidth='0.5' />
              {/* ルーン文字風の装飾 */}
              <text
                x='100'
                y='100'
          ...
          <div className='absolute bottom-20 right-20 w-48 h-48 border border-demon-gold/10 rounded-full animate-pulse-glow' style={{ animationDelay: '1s' }} />
        </div>
