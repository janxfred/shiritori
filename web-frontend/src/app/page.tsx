...
export default function HomePage() {
  ...
  const [lastPlayerResult, setLastPlayerResult] = useState<TurnResult | null>(
    null,
  );
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-8">
        <div className="text-center">
          ...
          <p className="text-demon-gold text-lg italic">「{demonMessage}」</p>
          <div className="mt-8">
            <div className="flex justify-center gap-12">
              <div className="text-center">
                <p className="text-demon-parchment/60 text-sm">汝の確保文字</p>
                <p className="text-demon-gold text-4xl font-bold">
                  {session?.playerCapturedChars.length ?? 0}
                </p>
              </div>
              <div className="text-demon-parchment text-4xl font-bold">vs</div>
              <div className="text-center">
                <p className="text-demon-parchment/60 text-sm">
                  悪魔の確保文字
                </p>
                <p className="text-red-400 text-4xl font-bold">
                  {session?.aiCapturedChars.length ?? 0}
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-8">
        <div className="text-center">
          ...
          <div className="demon-message rounded-lg p-6 mb-6 max-w-md mx-auto">
            <h2 className="text-demon-gold font-bold text-lg mb-4">
              悪魔の強さを選べ
            </h2>
          ...
          <div className="demon-message rounded-lg p-6 mb-8 max-w-md mx-auto text-left">
            <h2 className="text-demon-gold font-bold text-lg mb-3">
              契約の条件
            </h2>
        ...
        <div className="flex items-center gap-4">
          ...
          {session && (
            <div className="flex items-center gap-2">
              ...
              <span
                className={`text-sm font-bold ${session.isOvertime ? "text-red-400 animate-pulse" : "text-demon-gold"}`}
              >
                {session.isOvertime
                  ? "延長戦"
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="demon-message rounded-lg p-2 mb-2">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="text-demon-parchment text-lg italic">
                  「{demonMessage}」
                </p>
          ...
          {phase === "game_over" && (
            <div className="text-center py-8">
              <h2
                className={`text-4xl font-bold mb-4 ${winner === "player" ? "text-demon-gold" : "text-red-500"}`}
              >
              ...
              {/* レベル選択で再戦 */}
              <div className="demon-message rounded-lg p-6 mb-6 max-w-md mx-auto">
                <h3 className="text-demon-gold font-bold text-lg mb-4">
                  再戦を挑むか？
                </h3>
                <div className="flex gap-4 justify-center">
                  {([1, 2, 3] as AiLevel[]).map((level) => (
          ...
          >
            <h3 className="text-demon-gold font-bold mb-3 text-sm">
              言霊の記録
            </h3>
        ...
        <aside className="lg:w-64 gothic-border rounded-lg p-4 bg-demon-shadow/50">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-demon-gold font-bold">
                {session?.playerCapturedChars.length ?? 0}文字
              </span>
            </div>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-red-400 font-bold">
                {session?.aiCapturedChars.length ?? 0}文字
              </span>
            </div>
            <div className="flex flex-wrap gap-2">
          ...
          <div className="border-t border-demon-gold/20 pt-4">
            ...
            <div className="flex justify-between">
              <div>
                ...
                <span
                  className={`font-bold ${(session?.playerMistakeCount ?? 0) > 0 ? "text-red-400" : "text-demon-parchment"}`}
                >
              ...
              <div>
                ...
                <span
                  className={`font-bold ${(session?.aiMistakeCount ?? 0) > 0 ? "text-demon-gold" : "text-demon-parchment"}`}
                >
